...
public class _1_WebTables {
    ...
    public void printWholeTable() {
        ...
        System.out.println(wholeTableText);
    ...
    public void getAllColumnHeaders() {
        ...
        String expectedHeaders="First Name";

        Assert.assertTrue(columnHeaderNames.contains(expectedHeaders));
    ...
    public void getColumnHeadersOneByOne() {
        ...
        columnHeaders.forEach(header-> System.out.println(header.getText())); // bu

        for (WebElement header:columnHeaders){           // veya bu
            System.out.println("header.getText() = " + header.getText());
        }
    }

    @Test
    public void getSingleRow() {  // getSingleRow--> tek bir satiri al demek
        /**
         * navigate to https://the-internet.herokuapp.com/tables
        ...
        WebElement secondRow = driver
                .findElement(By.xpath("//table[@id='table1']/tbody/tr[2]"));
        System.out.println("secondRow.getText() = " + secondRow.getText());
        
        // get all row and print
        List<WebElement> allRowsWithoutHeaders = driver
    ...
    @Test
    public void getAllCellsInOne() {
        /**
         * navigate to https://the-internet.herokuapp.com/tables
         * get the second row info cell by cell and print it
         */
        List<WebElement> secondRowData = driver
                .findElements(By.xpath("//table[@id='table1']/tbody//tr[2]/td"));
        for (WebElement cellData:secondRowData) {
            System.out.println("cellData.getText() = " + cellData.getText());
        }
        System.out.println("Due " + secondRowData.get(3).getText());
    }
    ...
    public void getSingleCellOfTable() {
        ...
        System.out.println("dataOfCell(4,2) = " + dataOfCell(4, 2));
    ...
    private int getNumberOfRows() {
        List<WebElement> allRowWithoutHeader = driver
                .findElements(By.xpath("//table[@id='table1']/tbody/tr"));
    ...
    private int getNumberOfColumns() {
        List<WebElement> columnHeaders = driver
                .findElements(By.xpath("//table[@id='table1']/thead//th"));
 ...
 * Tables are made of <thead> and <tbody> -- tablolar genellikle <thead> ve
  <tbody> bölümlerinden oluşur.
 * <thead> --> this is the table header, here we have table column names -- sütun
  başlıklarını tanımlamak içindir.
 * <tr> table row, indicates one whole row  -- tablodaki bütün bir satırı tanımlar.
 * <th> --> this tag indicates a cell that is used for table headers  -- tek bir
  sütun/satır başlığını tanımlamak içindir
 ...
 * Note : Web Table'lardan veri çekmek için xPath kullanmak gerekir. (index ve
  child to parent işlevi nedeniyle)
 */
